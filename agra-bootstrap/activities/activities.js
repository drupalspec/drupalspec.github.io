;(function(){
    ...
    app.component('activityAddForm', {
        template: '<h1 class="page-header">Add Activity</h1><activity-form activity="$ctrl.activity"></activity-form>',
        controller: function () {
            this.activity = {
                name: '',
                description: '',
    ...
    app.component('activityEditForm', {
        template: '<h1 class="page-header">Edit Activity</h1><activity-form activity="$ctrl.activity"></activity-form>',
        controller: function () {
            this.activity = {
