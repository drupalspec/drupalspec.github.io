(function(){
    ...
    app.component('scheduleEditForm', {
        template: '<h1 class="page-header">Edit Schedule</h1><schedule-form activities="$ctrl.activities"></schedule-form>',
        controller: function(){
            this.activities = [0, 1];
        }
    });
    ...
    app.component('scheduleAddForm', {
        template: '<h1 class="page-header">Add Schedule</h1><schedule-form activities="$ctrl.activities"></schedule-form>',
        controller: function(){
            this.activities = [0];
        }
    });
