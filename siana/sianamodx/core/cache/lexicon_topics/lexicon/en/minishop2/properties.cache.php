<?php  return array (
  ...
  'ms2_prop_includeThumbs' => 'An optional comma-delimited list of Thumbnail sizes to include in selection. For example: "120x90,360x240" give you placeholders [[+120x90]] and [[+360x240]]. Thumbnails must be generted in gallery of product.',
  'ms2_prop_link' => 'Id of link of goods, which is automatically assigned when you create a new link in the settings.',
  'ms2_prop_master' => 'Id of the master product. If specified both "master" and "slave" - query will built for master.',
  'ms2_prop_slave' => 'Id of the slave product. If specified "master" this option will be ignored.',
  ...
  'ms2_prop_showUnpublished' => 'Show unpublished goods.',
  'ms2_prop_showDeleted' => 'Show deleted goods.',
  'ms2_prop_showHidden' => 'Show goods, that hidden in menu.',
  'ms2_prop_showZeroPrice' => 'Show goods with zero price.',
  ...
  'ms2_prop_tplSuccess' => 'Chunk with successfull message about snippet work.',
  ...
  'ms2_prop_tplDeliveriesOuter' => 'Chunk for templating of a block of possible ways of deliveries.',
  'ms2_prop_tplDeliveriesRow' => 'Chunk to process a way of delivery.',
  ...
  'ms2_prop_ignoreOptions' => 'Options that should be ignored by snippet',
